// ─────────────────────────────────────────────
//  CIVIQ — Sidebar (JSX)
//  Dynamic logo size — single LOGO_SIZE controls both
//  Creative SVG wordmark with accent dots on i letters
// ─────────────────────────────────────────────
...
const adminNav = [
  ...
  { id: 'projects',   label: 'Projects',   icon: I.projects,   count: 24,        countColor: 'muted'  },
  { id: 'conflicts',  label: 'Conflicts',  icon: I.conflicts,  count: 3,         countColor: 'danger' },
  { id: 'map',        label: 'City Map',   icon: I.map,        count: undefined, countColor: 'muted'  },
  { id: 'complaints', label: 'Complaints', icon: I.complaints, count: 7,         countColor: 'muted'  },
...
const officerNav = [
  { id: 'dashboard',  label: 'Dashboard',   icon: I.dashboard,  count: undefined, countColor: 'muted'  },
  { id: 'projects',   label: 'My Projects', icon: I.projects,   count: 8,         countColor: 'muted'  },
  { id: 'conflicts',  label: 'Conflicts',   icon: I.conflicts,  count: 1,         countColor: 'danger' },
  { id: 'map',        label: 'City Map',    icon: I.map,        count: undefined, countColor: 'muted'  },
...
const supervisorNav = [
  { id: 'dashboard', label: 'Dashboard', icon: I.dashboard, count: undefined, countColor: 'muted' },
  { id: 'tasks',     label: 'My Tasks',  icon: I.tasks,     count: 3,         countColor: 'muted' },
  { id: 'settings',  label: 'Settings',  icon: I.settings,  count: undefined, countColor: 'muted' },
]

// ─── CIVIQ Logo Icon ───────────────────────────
// size = LOGO_SIZE — same as wordmark height
...
// ─── Creative Logo Wordmark ────────────────────
// size = LOGO_SIZE — matches icon height exactly
// dotless ı letters + accent brand dots above
function LogoWordmark({ size = 34, dark = false }) {
  ...
  return (
    ...
    >
      ...
      {/* accent dot above first i — brand color */}
      ...
      {/* accent dot above second i — brand color */}
...
export default function Sidebar({
  ...
  // 🔥 Single source of truth — change this one number
  const LOGO_SIZE = 34
